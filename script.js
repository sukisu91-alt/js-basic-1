...
console.log(typeof pestaña);
console.log(typeof home);
console.log(typeof student1);
console.log(typeof food);

//investigar la funion typeoff//
//funcion typeoff JS//goggle ---typeof=¿Qué tipo de cosa es esta variable?”JavaScript te responde
...
console.log(comparacion);                   //<(menor que)>(mayor que)
